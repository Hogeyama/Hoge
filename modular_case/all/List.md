...
+ `Ai.mk_binding_depgraph_for_terms`
    ...
    + 直前でvarsがnilでないことを確認しているので行ける → [詳細](../likely_to_be_verified.md#Ai__mk_binding_depgraph_for_terms)
...
+ `Main.report_breakdown`:
    ...
    + 検証できそう → [詳細](../likely_to_be_verified.md#Main__report_breakdown)
...
+ `Ai.mk_trtab`
    ...
    + 検証できそう → [詳細](../likely_to_be_verified.md#Ai__mk_trtab)
